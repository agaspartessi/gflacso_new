...
// default text editor and "Atto" does not need thsis setting so we won't provide anything. If we did it would work the same         
...
$THEME->scss = function($theme) {                                                                                                   
    return theme_gflacso_new_get_main_scss_content($theme);                                                                               
};

$THEME->layouts = [
  // My dashboard page.
  'mydashboard' => array(
    'file' => 'columns2-dashboard.php',
