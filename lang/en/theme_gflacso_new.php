...
$string['choosereadme'] = 'Theme gflacso_new is a child theme of Boost. It adds the ability to upload background gflacso_news.';                
// Name of the settings pages.                                                                                                      
$string['configtitle'] = 'gflacso_new settings';                                                                                          
...
$string['skip_access'] = 'Skip Slider';
